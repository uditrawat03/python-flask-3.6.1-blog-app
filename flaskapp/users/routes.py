...
from flaskapp.users.forms import (
    RegistrationFrom, LoginFrom, UpdateAccountForm, RequestResetForm, ResetPasswordForm)
from flaskapp.users.util import save_picture, send_reset_email
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash('Invalid Credetials', 'danger')
...
def reset_password(token):
    ...
    return render_template('reset_pa.html', title='Reset Request', form=form)
